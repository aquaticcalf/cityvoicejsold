...
function Left() {
    ...
    return (
        <div className="p-2 grow flex-col gap-5 items-center max-w-[400px] text-[#FFFFFF] h-screen relative hidden xl:flex">
          ...
          <hr className="border-[0.2px] w-[90%] border-[#636363]" />
